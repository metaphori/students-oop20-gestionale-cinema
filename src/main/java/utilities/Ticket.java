...
public class Ticket<X,Y> {
	private final Calendar data;
	private final Set<Seat<X,Y>> setSeat;
	private final Double price;
	private final String titleFilm;
	private final String hall;
	
	public Ticket(Calendar data, Set<Seat<X,Y>> setSeat, Double price, String titleFilm, String hall) {
		this.data=data;
		this.hall=hall;
	...
	public Set<Seat<X, Y>> getSetSeat() {
		return setSeat;
	}
